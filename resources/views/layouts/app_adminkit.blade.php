...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Admin Simaskeu</span>
        </a>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item {{ Route::is('kas.*') ? 'active' : '' }}">
						<a class="sidebar-link" href="{{ route('kas.index') }}">
              				<i class="align-middle" data-feather="activity"></i> <span class="align-middle">Keuangan Masjid</span>
            			</a>
					</li>

					<li class="sidebar-item {{ Route::is('rabs.*') ? 'active' : '' }}">
						<a class="sidebar-link" href="{{ route('rabs.index') }}">
              				<i class="align-middle" data-feather="activity"></i> <span class="align-middle">Rancangan Anggaran</span>
            			</a>
					</li>

					<li class="sidebar-item {{ Route::is('users.*') ? 'active' : '' }}">
						<a class="sidebar-link" href="{{ route('users.index') }}">
              				<i class="align-middle" data-feather="activity"></i> <span class="align-middle">Data Donatur</span>
            			</a>
					</li>
